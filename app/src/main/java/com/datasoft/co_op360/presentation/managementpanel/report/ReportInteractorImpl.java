...
public class ReportInteractorImpl implements ReportInteractor {
    ...
    public List<ReportData> createArrayList() {
        ...
        ReportData reportData1 = new ReportData("#4A148C", "#6A1B9A", "1", "MP First Report");
        ReportData reportData2 = new ReportData("#880E4F", "#AD1457", "2", "MP Second Report");
        ReportData reportData3 = new ReportData("#0D47A1", "#1565C0", "3", "MP Third Report");
