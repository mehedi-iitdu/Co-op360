...
public class AutoProcessMemberList extends AppCompatActivity implements AutoProcessMemberListView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Group Wise RESTMember List");

        foAutoProcessMemberListPresenter = new FoAutoProcessMemberListPresenterImpl(this);
        progressDialog = new ProgressDialog(this);
        recyclerView = (RecyclerView) findViewById(R.id.rv_member_list);
        foAutoProcessMemberListPresenter.getMemberList();
    }

    @Override
    public void setProcesses(List<MemberListData> list) {
    ...
    @Override
    public void onItemclick(MemberListData memberListData) {
