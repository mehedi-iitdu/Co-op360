...
public class SecureSharedPreferences {
    ...
    private static SecureSharedPreferences instance = null;
    ...
    public SecureSharedPreferences(Context context, String preferenceName,
    ...
    public static SecureSharedPreferences getInstance(Context contxt, String prefName) {
        if (instance == null) {
            instance = new SecureSharedPreferences(contxt, prefName,
                    prefName + "Key", true);
        }
        return instance;
    }
